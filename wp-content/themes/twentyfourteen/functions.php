...
function extra_styles() {
    ...
    wp_enqueue_style('bootstrap-css', get_stylesheet_directory_uri().'/css/dist/css/bootstrap.min.css');
    wp_enqueue_style('screen', get_stylesheet_directory_uri().'/css/screen.css');
}
add_action('wp_enqueue_scripts', 'extra_styles');

wp_register_script(
    'bootstrap-js'
   ,get_stylesheet_directory_uri().'/css/dist/js/bootstrap.min.js'
   ,array('jquery')
);

wp_register_script(
    'florissant-js'
   ,get_stylesheet_directory_uri().'/js/florissant.js'
   ,array('jquery')
);

function enqueue_site_scripts() {
    wp_enqueue_script('jquery-ui-core');
    wp_enqueue_script('jquery-effets-core');
    wp_enqueue_script('jquery-ui-draggable');
    wp_enqueue_script('bootstrap-js');
    wp_enqueue_script('florissant-js');
}
